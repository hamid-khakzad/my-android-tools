...
//		super.setOnScrollListener(this);
     ...
     * {@link HeaderFooterGridAdapter}, it will be wrapped with a supporting
    ...
    public void addHeaderView(View v, Object data, boolean isSelectable) {
        ...
        if (mAdapter != null) {
            if (!(mAdapter instanceof HeaderFooterGridAdapter)) {
                mAdapter = new HeaderFooterGridAdapter(mHeaderViewInfos, mFooterViewInfos, mAdapter);
            }
    ...
    public boolean removeFooterView(View v) {
        if (mFooterViewInfos.size() > 0) {
            ...
            if (mAdapter != null && ((HeaderFooterGridAdapter) mAdapter).removeFooter(v)) {
                notifiyChanged();
                result = true;
            }
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        if (mHeaderViewInfos.size() > 0|| mFooterViewInfos.size() > 0) {
            mAdapter = new HeaderFooterGridAdapter(mHeaderViewInfos, mFooterViewInfos, adapter);
        } else {
            mAdapter = adapter;
        }
