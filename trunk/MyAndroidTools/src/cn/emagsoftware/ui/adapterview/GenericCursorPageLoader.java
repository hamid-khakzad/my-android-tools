 ...
 */
public abstract class GenericCursorPageLoader extends GenericCursorLoader implements PageInterface<Cursor> {
    ...
    public GenericCursorPageLoader(Context context, Cursor oldData, int pageSize) {
