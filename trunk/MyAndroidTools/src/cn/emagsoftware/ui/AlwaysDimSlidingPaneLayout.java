 ...
 */
public class AlwaysDimSlidingPaneLayout extends ViewGroup {
    private static final String TAG = "AlwaysDimSlidingPaneLayout";
    ...
    public AlwaysDimSlidingPaneLayout(Context context) {
        this(context, null);
    }

    public AlwaysDimSlidingPaneLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AlwaysDimSlidingPaneLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(AlwaysDimSlidingPaneLayout parent, View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        public void invalidateChildRegion(AlwaysDimSlidingPaneLayout parent, View child) {
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(AlwaysDimSlidingPaneLayout.class.getName());
            info.setSource(host);
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(AlwaysDimSlidingPaneLayout.class.getName());
        }
    ...
    private class DisableLayerRunnable implements Runnable {
        ...
        @Override
        public void run() {
            if (mChildView.getParent() == AlwaysDimSlidingPaneLayout.this) {
