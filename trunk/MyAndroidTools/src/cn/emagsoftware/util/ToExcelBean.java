...
public class ToExcelBean {
	...
	public ToExcelBean(File newFile){
		if(newFile == null) throw new NullPointerException();
	...
	public ToExcelBean(File modelFile, File newFile){
		if(modelFile == null || newFile == null) throw new NullPointerException();
